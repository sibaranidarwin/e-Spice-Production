...
class FilterAdminController extends Controller
{
    function filter(){
        ...
        return view('admin.po.all',compact('good_receipts', 'dispute', 'start_date', 'end_date', 'vendor_name', 'vendor'))
    ...
    function filternot(){
        ...
        return view('admin.po.notver',compact('good_receipts', 'dispute', 'start_date', 'end_date', 'status', 'vendor_name', 'vendor'))
                ->with('i',(request()->input('page', 1) -1) *5);
    }
    function filterver(){
        if (request()->start_date || request()->end_date ||  request()->vendor){
        ...
        return view('admin.po.ver',compact('good_receipts', 'dispute', 'start_date', 'end_date', 'status','vendor', 'vendor_name'))
        ->with('i',(request()->input('page', 1) -1) *5);
    }
    ...
    function filterreject(){
        ...
        return view('admin.po.reject',compact('good_receipts', 'dispute', 'start_date', 'end_date', 'status', 'vendor_name', 'vendor'))
        ->with('i',(request()->input('page', 1) -1) *5);
    }
    function filterdisp(){
        if (request()->start_date || request()->end_date || request()->vendor){
        ...
        return view('admin.po.disputed',compact('good_receipts', 'start_date', 'end_date', 'status', 'vendor_name', 'vendor'))->with('i',(request()->input('page', 1) -1) *5);
    }
