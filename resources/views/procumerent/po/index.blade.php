                    ...
                    <div class="card-body">
                        <div class="table-responsive text-nowrap">
                            ...
                            <p style="text-align: center; background-color: #11CDEF; color: white;"><strong
                                    ...
                                    To: {{ Carbon\Carbon::parse($end_date)->format('d F Y') }} Status Invoice Proposal:
                                    {{ ($status) }}</strong></p>
                            @endif
                            <form action="{{ route('procumerent-filternot') }}" class="form-inline" method="GET">
                                        ...
                                        <div class="card responsive bg-light card-outline-danger text-cen">
                                            ...
                                            <div class="card-block text-white">
                                                <blockquote class="card-blockquote text-white">
                                                    <p style="font-size: 14px;"><strong>&nbsp; Good receipt Not verified
                                                            description: </strong></p>
                                                    <p style="font-size: 13px;"><strong>&nbsp; Not verified: good
                                                            receipt data that has certain conditions and requires
                                                            verification <br>&nbsp; by the vendor.
                                                            Certain conditions in the GR data that enter the not
                                                            verified status are <br>&nbsp; combinations where the data
                                                            posting date, material number, quantity, vendor id and
                                                            <br>&nbsp;
