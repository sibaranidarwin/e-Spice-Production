                            ...
                            <div class="col-md-12">
                                <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Verified</a>
                                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Not Yet Verified - Draft BA</a>
                                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Verified - BA</a>
                                    </div>
                                </nav>
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if ($start_date != null || $end_date != null)
                                             ...
                                             <form action="{{ route('vendor-filter') }}" class="form-inline" method="GET">
                                                ...
                                                {{-- <h1> GR_Date:{{ Carbon\Carbon::parse($start_date)->format('d F Y') }} To: {{ Carbon\Carbon::parse($end_date)->format('d F Y') }}</h1> --}}
                                                <form action="{{ route('update-datagr-vendor/{id_gr}') }}" method="POST">
                                                    @csrf
                                                    <table  class="table table-striped" id="TABEL_1" style="width:100%; font-size: 10px;">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody style="font-size: 11px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                @elseif ($good_receipt->status_invoice_proposal == 'Verified - BA')
                                                                <td><input disabled type="hidden" name="ids[]" value="{{$good_receipt->id_gr}}"></td>
                                                                @else
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="card-body">
                            <div class="table-responsive text-nowrap ">
                                ...
                                <form action="{{ route('update-datagr-vendor/{id_gr}') }}" method="POST">
                                    @csrf
                                    <table  class="table table-striped" id="TABEL_2" style="width:100%; font-size: 10px;">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" disabled onchange="checkAll(this)"></th>
                                                <th style="text-align: center;">Sts. GR</th>
                                                <th style="text-align: center;">Sts. Inv. Props.</th>
                                                <th style="text-align: center;">Plant Code</th>
                                                <th style="text-align: center;">PO</th>
                                        ...
                                        <tbody style="font-size: 11px;">
                                            ...
                                            <tr>
                                                @if ($good_receipt->status_invoice_proposal == 'Not Yet Verified - Draft BA')
                                                <td><input type="checkbox" disabled name="ids[]" value="{{$good_receipt->id_gr}}"></td>
                                                @elseif ($good_receipt->status_invoice_proposal == 'Verified - BA')
                                                <td><input type="checkbox" disabled name="ids[]" value="{{$good_receipt->id_gr}}"></td>
                                                @else
                                                <td><input type="checkbox" name="ids[]" value="{{$good_receipt->id_gr}}"></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="card bg-light card-outline-danger text-cen">
                                                ...
                                                <div class="card-block text-white">
                                                  <blockquote class="card-blockquote text-white">
                                                    <p style="font-size:l 14px;"><strong>&nbsp; Good receipt status description: </strong></p>
                                                    <p style="font-size: 13px;"><strong>&nbsp; 1. Verified: good receipt data with this status means that this data comes from the <br> warehouse and has been verified by the warehouse.</strong></p>
                                                    <p style="font-size: 13px;"><strong>&nbsp; 2. Auto Verify: good receipt data with this status means the data from SAP is correct <br> and does not have certain conditions.</strong></p>
                                                </blockquote>
                                                </div>
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <div class="card-body">
                            <div class="table-responsive text-nowrap ">
                                ...
                                <form action="{{ route('update-datagr-vendor/{id_gr}') }}" method="POST">
                                    @csrf
                                    <table class="table table-striped" id="TABEL_3" style="width:100%; font-size: 10px;">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" disabled onchange="checkAll(this)"></th>
                                                <th style="text-align: center;">Sts. GR</th>
