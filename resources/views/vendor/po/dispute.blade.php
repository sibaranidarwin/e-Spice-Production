                    ...
                    <div class="card-body">
                        <form autocomplete="off" action="{{ route('dispute_datagr') }}" method="post"
                            ...
                            <button type="submit" name="action" value="Dispute"
                                onclick="return confirm('Are you sure?')" class="btn btn-warning"
                                id="simpan">Dispute</button>
                            <a href="{{url('vendor/purchaseorder')}}" onclick="return confirm('Are you sure?')"
                        ...
                        <table id="list" class="table table-stats order-table ov-h">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <span class="">{{$good_receipt->material_number}}
